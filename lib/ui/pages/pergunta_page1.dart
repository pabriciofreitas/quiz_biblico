                        ...
                        if (questao.viuResposta == true) {
                          ...
                          */
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                //settings: ,
                                builder: (context) => (PerguntasPage2()),
                                settings: RouteSettings(
                                  name: "/profile",
                                  arguments: pontos,
                                ),
...
void initState() {
      ...
      Map argumentsMap = arguments as Map<String, dynamic>;
      List<Pagina> lista = argumentsMap["questoes"];

      Random random = Random();
      int randomNumber = random.nextInt(10);
      Pagina questao = lista[1];
      //print(a);
      super.initState();
    }
