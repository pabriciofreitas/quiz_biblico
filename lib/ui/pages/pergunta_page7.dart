...
import 'pages.dart';
import 'pergunta_page8.dart';

class PerguntasPage7 extends StatefulWidget {
  const PerguntasPage7({Key? key}) : super(key: key);

  @override
  _PerguntasPage7State createState() => _PerguntasPage7State();
}

var questao = Controller.p7;
...
class _PerguntasPage7State extends State<PerguntasPage7> {
  @override
                      ...
                      setState(() {
                        ...
                        if (questao.viuResposta == true) {
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                //settings: ,
                                builder: (context) => (PerguntasPage8()),
